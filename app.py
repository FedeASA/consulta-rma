...
st.markdown(
    ...
    <style>
        ...
        /* ── Header underline: thick gradient bar ── */
        .tabla1-header-divider {
            height: 2px;
            background: linear-gradient(90deg, #2d5a9e 0%, #2a2a3e 100%);
            border: none;
            border-radius: 1px;
        ...
        /* ── Row separators ── */
        .row-sep { width:100%; border-radius:1px; margin:3px 0 6px 0; }

        /* Table 1 — alternating neutral tones */
        .row-sep-even { height:1px; background:rgba(180,200,240,0.15); }
        .row-sep-odd  { height:1px; background:rgba(255,255,255,0.05); }

        /* Status-based (Tables 2 & 3) — 2px colored lines */
        .row-sep-nc      { height:2px; background:rgba(40,167,69,0.60);  }
        .row-sep-cambio  { height:2px; background:rgba(23,162,184,0.60); }
        .row-sep-rechazo { height:2px; background:rgba(220,53,69,0.60);  }
        .row-sep-pending { height:2px; background:rgba(255,193,7,0.45);  }

        /* ── Resolution badges ── */
        .badge-nc        { background:#28a745; color:#fff; padding:2px 9px;
                           border-radius:4px; font-size:12px; font-weight:600; }
        .badge-cambio    { background:#17a2b8; color:#fff; padding:2px 9px;
                           border-radius:4px; font-size:12px; font-weight:600; }
        .badge-rechazado { background:#dc3545; color:#fff; padding:2px 9px;
                           border-radius:4px; font-size:12px; font-weight:600; }
    </style>
    """,
